...
@section('content')
<!-- content start -->
<div class="container-fluid p-0 home-content container-top-border mt-0">
    <!-- account block start -->
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center g-2">
            <div class="col-4">
                <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/img3.webp"
                    alt="Login image" class="w-25 vh-25" style="object-fit: cover; object-position: left;">
            </div>
                        ...
                        <div class="p-4">
                            ...
                            <div class="form-group">
                                <div class="row m-0">
                                    ...
                                    <div class="col-6">
                                        <a href="{{ route('password.request') }}" class="float-right forgot-text">Forgot
                                            password?</a>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <button type="submit"
                                    class="btn btn-lg btn-block login-page-button button-lgn button2">Login</button>
                            </div>
                        </div>
                    </form>
                </div>
