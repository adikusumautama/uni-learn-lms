...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('backend/assets/images/logo-hitam.png ') }}">
...
<body>
    <nav class="site-navbar navbar navbar-default navbarnavbar-mega navbar-expand-md navbar1"
        role="navigation">
        ...
        <div class="navbar-header" style="background-color:#427D9D">
            ...
            <div class="navbar-brand navbar-brand-center mt-30">
                <img class="navbar-brand-logo" src="{{ asset('backend/assets/images/logo-hitam.png') }}"
                    title="UNI-LEARN">
        ...
        <div class="navbar-container container-fluid">
          ...
          <li class="nav-item dropdown">
            ...
            <!-- Site Navbar Seach -->
            <div class="collapse navbar-search-overlap ml-500" id="site-navbar-search">
                <form role="search">
